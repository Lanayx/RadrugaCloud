namespace Core.Tools
{
    ...
    using Core.Tools.ExpressionWriters;
    ...
    public class ExpressionWriter
    {
        ...
        private static readonly ExpressionType[] CompositeExpressionTypes =
            {
        ...
        private readonly IMethodCallWriter[] _methodCallWriters =
            {
                ...
                new EmptyAnyMethodWriter(), new AnyAllMethodWriter(), 
            ...
            ConstantExpression comparisonExpression)
        {
            if (methodCallExpression != null && methodCallExpression.Method.Name == "CompareTo"
                && methodCallExpression.Method.ReturnType == typeof(int) && comparisonExpression != null
        ...
        private string WriteMemberAccess(Expression expression, ParameterExpression rootParameterName)
        {
            ...
            while (currentMemberExpression != null)
            {
                ...
                if (currentMemberExpression.Expression is ParameterExpression && rootParameterName != null
